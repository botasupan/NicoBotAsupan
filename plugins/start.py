...
async def not_joined(client: Client, message: Message):
    text = "<b>MAAF, AKSES NONTON VIDEO DITOLAK!!!\n\nKamu harus BERGABUNG dulu Baru Bisa Akses Video</b>"
    message_text = message.text
    try:
        command, argument = message_text.split()
        text = text + f" <b>LALU KLIK<a href='https://t.me/{client.username}?start={argument}'>COBA LAGI</a></b>"
    except ValueError:
        pass
